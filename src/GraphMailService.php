...
class GraphMailService
{
    ...
    public function sendMail(string $to, string $subject, string $body, string $contentType = 'HTML', array $attachment_paths = []): bool
    {
        // Token holen
...
//HTML;
        ...
        // Graph API senden
        $response = Http::withToken($accessToken)->post("https://graph.microsoft.com/v1.0/users/{$this->fromAddress}/sendMail", [
            'message' => [
                'subject' => $subject,
                'body' => [
